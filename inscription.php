...
<?php
	...
	if (isset($_POST['submit'])) 
	{
		...
		{
			$_SESSION['error'] = 'Vous devez entrer un prenom pour pouvoir vous inscrire.';
			header("Location: inscription.php");
			return;
		}
		elseif (empty($_POST['nom'])) 
		{
			$_SESSION['error'] = 'Vous devez entrer un nom pour pouvoir vous inscrire.';
			header("Location: inscription.php");
			return;
		}
		// EMPTY PASSWORD
		...
		// OK, CONTINUE
			...
			// LASTNAME TOO LONG
			elseif ($nomlength > 255) 
			{
				$_SESSION['error'] = "Votre nom est trop long.";
				header('location: inscription.php');
               	return;
			}
			// FIRSTNAM TOO LONG
			elseif ($prenomlength > 255) 
			{
				$_SESSION['error'] = "Votre prenom est trop long.";
				header('location: inscription.php');
               	return;
			}
			// PASSWORD TOO LONG
			...
			// OK, CONTINUE
				...
				// OK, CONTINUE
					...
					$rgt = "INSERT INTO utilisateurs (login, prenom, nom, password) VALUES (:login, :prenom, :nom, :password)";
